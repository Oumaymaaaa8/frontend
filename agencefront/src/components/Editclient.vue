...
export default {
    ...
    methods: {
        ...
        updateClient() {
            ...
            axios.put(`clients/${id}`, payload)

                .then(response => {
                    console.log('cliet mis à jour avec succès:', response.data);
                    this.$router.push('/app/clients'); // Redirection après mise à jour
                })
                .catch(error => {
